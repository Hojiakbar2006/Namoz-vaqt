...
async def remove_inline(query, context, chat_id, message_id):
    ...
    buttons = [
        [
            InlineKeyboardButton(text=informs[0]['namaz_name'], callback_data=f"namaz_{
                                 informs[0]['id']}"),
            InlineKeyboardButton(text=informs[1]['namaz_name'], callback_data=f"namaz_{
                                 informs[1]['id']}")
        ],
        [
            InlineKeyboardButton(text=informs[2]['namaz_name'], callback_data=f"namaz_{
                                 informs[2]['id']}"),
            InlineKeyboardButton(text=informs[3]['namaz_name'], callback_data=f"namaz_{
                                 informs[3]['id']}")
        ],
        [
            InlineKeyboardButton(text=informs[4]['namaz_name'], callback_data=f"namaz_{
                                 informs[4]['id']}"),
            InlineKeyboardButton(text=informs[5]['namaz_name'], callback_data=f"namaz_{
                                 informs[5]['id']}")
        ],
